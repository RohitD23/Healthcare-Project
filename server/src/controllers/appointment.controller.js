...
const { addAppointment, getAppoints } = require("../model/appointment.model");
...
const getDocAppoints = async (req, res) => {
  try {
    ...
    const appoints = await getAppoints(doctorName);
...
module.exports = { submitAppointment, getDocAppoints };
