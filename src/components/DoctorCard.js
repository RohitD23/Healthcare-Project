    ...
    <Container>
        <HeaderContainer>
            ...
            <DoctorInfoContainer>
                ...
                <Experience>{doctorInfo.experience + ' years of experience overall'}</Experience>
        ...
        <AppointmentInfoContainer>
            ...
            <InfoContainer id='location-info'>
                <IoLocationSharp style={{color : 'ff8300', scale : '2.5'}}></IoLocationSharp>
                <InfoText  style={{padding : '0 1rem'}}>{doctorInfo.location}</InfoText>
            </InfoContainer>
...
/*
<ClinicLocationInfoContainer>
                <IoLocationSharp style={{color : 'ff8300', scale : '2.5'}}></IoLocationSharp>
                <ClinicLocation>Sasun Hospital, Pune</ClinicLocation>
            </ClinicLocationInfoContainer>

            <ConsultaionFeesContainer>
                <ConsultationFeesText>Consultation Fees : </ConsultationFeesText>
                <ConsultationFeesValue>500</ConsultationFeesValue>
            </ConsultaionFeesContainer>*/